...
function buildPrompt(board, currentTurn, moveNumber) {
...
async function geminiAnalyze(board, currentTurn, moveNumber) {
...
async function getIntensity(board, currentTurn, moveNumber) {
    const elapsed = (0, logger_1.timer)();
