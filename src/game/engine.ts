import type { Board, Mark, WinResult, GameResult } from './types';
 ...
 */
export function checkGameResult(board: Board): GameResult | null {
 ...
 */
export function placeMarker(board: Board, cell: number, mark: Mark): Board {
