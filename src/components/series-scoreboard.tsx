...
export default function SeriesScoreboard({ series }: SeriesScoreboardProps) {
  const winsNeeded = 3;
    ...
    <div className="bg-gray-900 border border-gray-700 rounded px-4 py-2 text-sm text-center space-y-1 w-64">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-blue-400">
          ...
          <div className="flex gap-1">{renderDots(series.wins.X)}</div>
        ...
        <div className="flex items-center gap-2 text-red-400">
          ...
          <div className="flex gap-1">{renderDots(series.wins.O)}</div>
